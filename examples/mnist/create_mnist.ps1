...
C:\Users\z003ncra\caffe-windows\build\bin\convert_mnist_data.exe $DATA\train-images.idx3-ubyte `
  $DATA\train-labels.idx1-ubyte $EXAMPLE\mnist_train_$BACKEND --backend=$BACKEND
C:\Users\z003ncra\caffe-windows\build\bin\convert_mnist_data.exe $DATA\t10k-images.idx3-ubyte `
